...
namespace AgAmuasiBooking.Migrations
{
    ...
    [Migration("20251103143003_BkingExtras")]
    partial class BkingExtras
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgAmuasiBooking.Models.ExtraServices", b =>
                {
                    b.Property<int>("ExtraServicesID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("extraservicesid");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("ExtraServicesID"));

                    b.Property<string>("Biller")
                        .IsRequired()
                        .HasMaxLength(35)
                        .HasColumnType("character varying(35)")
                        .HasColumnName("biller");
                    ...
                    b.HasKey("ExtraServicesID")
                        .HasName("pk_extraservices");

                    b.HasIndex("BookingsID", "ServiceName");
            ...
            modelBuilder.Entity("AgAmuasiBooking.Models.ExtraServices", b =>
                {
                    b.HasOne("AgAmuasiBooking.Models.Bookings", "Bookings")
                        .WithMany("ExtraServices")
                        .HasForeignKey("BookingsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_extraservices_bookings_bookingsid");
